                                ...
                                <form action="<?= site_url('admin/product/insert_update') ?>" method="post">
                                    <div class="grid grid-cols-12 gap-x-5">
                                        <div class="col-span-12 2xl:col-span-6">
                                            <div>
                                                <label for="update-profile-form-1" class="form-label">Nama Tampilan</label>
                                        ...
                                        <div class="col-span-12 2xl:col-span-6">
                                            ...
                                            <div class="mt-3">
                                                <label for="update-profile-form-4" class="form-label">Harga Produk</label>
                                        ...
                                        <div class="col-span-12">
                                            <div class="mt-3">
                                                ...
                                                <textarea id="update-profile-form-5" class="form-control" name="keterangan"><?= $row->keterangan ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="w-52 mx-auto xl:mr-0 xl:ml-6">
                                <div class="border-2 border-dashed shadow-sm border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                    <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                        ...
                                        <div title="Hapus foto profil ini?" class="tooltip w-5 h-5 flex items-center justify-center absolute rounded-full text-white bg-danger right-0 top-0 -mr-2 -mt-2"> <i data-lucide="x" class="w-4 h-4"></i> </div>
                                    </div>
                                    <div class="mx-auto cursor-pointer relative mt-5">
                                        <button type="button" class="btn btn-primary w-full">Gambar Produk</button>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>

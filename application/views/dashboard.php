            ...
            <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3">
                <div class="box">
                    ...
                    <div class="flex justify-center lg:justify-end items-center p-5 border-t border-slate-200/60">
                        <a class="flex items-center btn btn-sm btn-primary mr-3" href="<?= site_url('dashboard/cart/' . $row->id_brg) ?>"> <i data-lucide="shopping-cart" class="w-4 h-4 mr-1"></i> Tambahkan Ke Keranjang </a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
